...
contract('AuctionContract', function (accounts) {
  ...
  //Test Case for checking if the bid is more than the token amount
      ...
      .then(function (result) {
        ...
        */
        ...
        if(e === "Failed to check remaining tokens less than count") {
          ...
          ***********/
          /*<CODE HERE>*/assert(false);
        } else {
          /**********
          TASK 3: assert the opposite here
          ***********/
          /*<CODE HERE>*/assert(true);
        }
      })
    });
    ...
    it("Should NOT allow non owner to reveal winners", function() {
      ...
      ***********/
       return /*<CODE HERE>*/ auctionInstance.revealWinners({from: accounts[1]})
    ...
    it("Should set winners", function() {
      ...
      ***********/
      return /*<CODE HERE>*/ auctionInstance.register({from: accounts[2]})
      .then(function(result) {
        /**********
        ...
        ***********/
        /*<CODE HERE>*/ assert.notEqual(result, 0x0000000000000000000000000000000000000000, 'Winner address is not the default address')
        /**********
        TASK 16: call winners function from accounts[0] to get the winner of item id 1
        ***********/
        return /*<CODE HERE>*/ auctionInstance.winners(1)
      }).then(function(result) {
        /**********
        ...
        ***********/
        return /*<CODE HERE>*/ auctionInstance.winners(2)
      }).then(function(result) {
        /**********
